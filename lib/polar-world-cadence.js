...
export const WORLD_DRESSING_BUDGET = Object.freeze({
  low: Object.freeze({ near: 18, mid: 10, far: 4, total: 32, drawCalls: 3 }),
  medium: Object.freeze({ near: 31, mid: 14, far: 7, total: 52, drawCalls: 3 }),
  high: Object.freeze({ near: 50, mid: 20, far: 10, total: 80, drawCalls: 3 }),
});
