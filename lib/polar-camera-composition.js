...
const MECHANISM_VERTICAL_ENVELOPES = Object.freeze({
  ...
  // s2: stilted server hut, local -0.69 foot pads to a 1.16 uplink whip tip at
  // hero scale 1.65. manifold-reactor: generator hall, local -0.66 plinth to a
  // 1.34 stack-plume crown at hero scale 1.78 — the plume must stay framed.
  // qpu-ice-bridge: ice-core drill rig, local -0.62 foot pads on the snow to a
  // 1.08 crown-block finial at hero scale 1.88 — the derrick must stay framed,
  // and the rig no longer floats, so the base is a real ground contact.
  "s2-kernel-core": Object.freeze({ height: 3.05, primaryFloor: 0.8 }),
  "manifold-reactor": Object.freeze({ height: 3.56, primaryFloor: 0.36 }),
  "field-chamber-coils": Object.freeze({ height: 2.04, primaryFloor: 0.38 }),
  "qpu-ice-bridge": Object.freeze({ height: 3.2, primaryFloor: 0.68 }),
