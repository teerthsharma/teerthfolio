...
export const POLAR_DOME_LATTICE_GEOMETRY = Object.freeze({
  ...
  radii: Object.freeze([2.42, 1.46, 1.48]),
  thetaBase: HALF_PI,
  thetaTop: 0.1,
});
...
export const POLAR_DOME_AIRLOCK = Object.freeze({
  ...
  innerRadius: 0.32,
  outerRadius: 0.52,
  position: Object.freeze([0.62, 0.035, 1.08]),
...
export const POLAR_DOME_LATTICE_TIERS = Object.freeze({
  low: Object.freeze({
    cellBudget: Object.freeze({ min: 30, max: 84 }),
    maxColumns: 14,
    minColumns: 7,
    radialRibs: 4,
    ringCount: 6,
    targetCellWidth: 0.74,
  }),
  medium: Object.freeze({
    cellBudget: Object.freeze({ min: 56, max: 144 }),
    maxColumns: 18,
    minColumns: 8,
    radialRibs: 6,
    ringCount: 8,
    targetCellWidth: 0.64,
  }),
  high: Object.freeze({
    cellBudget: Object.freeze({ min: 80, max: 240 }),
    maxColumns: 24,
    minColumns: 9,
    radialRibs: 8,
    ringCount: 10,
    targetCellWidth: 0.56,
  }),
});
...
function makeCell({
  ...
  const width = (circumference / columnCount) * 0.955;
  const height = Math.hypot(...frame.thetaDerivative) * thetaBand * 0.95;
  ...
  const thickness = 0.122 + ringIndex * 0.0034 + frostSeed * 0.008;
  const scale = [
