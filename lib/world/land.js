...
export const LAND_COLLIDERS = [
  { x: -8, z: 11, radius: 1.7, land: "mapboard" }, // the map board at the start (MAP_BOARD below)
...
// The map board beside spawn (components/world/MapBoard.jsx), clear of the
// trails and the name in the snow; its collider leads LAND_COLLIDERS.
export const MAP_BOARD = { x: -8, z: 11 };
