...
let ui = {
  ...
  cutscene: null, // id of the place whose first-arrival moment is playing (moments.js ARRIVAL)
};
...
export const live = {
  ...
  // The first-arrival moment (moments.js ARRIVAL) and the places seen this
  // session (Controller.jsx loads and saves them in sessionStorage).
  arrival: { id: null, start: -100, keys: null, target: null, stick: null },
  seen: new Set(),
};
