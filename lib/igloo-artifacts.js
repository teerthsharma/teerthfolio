...
export const IGLOO_ARTIFACTS = [
  {
    ...
    // The repositories this station is actually built on. A station that names its
    // evidence but cannot be opened is a label, not a citation — these are what make
    // the building reachable. Every URL is resolved from data/project-intelligence.json
    // (fullName/url), never constructed from the display name: the two disagree often
    // enough to matter (Hamilton -> hamliton, NeMo Relay -> NeMo-Relay, TopoBridge-Q ->
    // topobridge-q). A name with no resolvable repo is deliberately absent rather than
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "teerthsharma", url: "https://github.com/teerthsharma" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "Epsilon-Hollow", url: "https://github.com/teerthsharma/Epsilon-Hollow" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "Aether-Lang", url: "https://github.com/teerthsharma/Aether-Lang" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "Faraday", url: "https://github.com/teerthsharma/faraday" },
      { name: "Hamilton", url: "https://github.com/teerthsharma/hamliton" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "TopoBridge-Q", url: "https://github.com/teerthsharma/topobridge-q" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "Triton", url: "https://github.com/teerthsharma/triton" },
      { name: "PyTorch", url: "https://github.com/teerthsharma/pytorch" },
      { name: "NeMo Relay", url: "https://github.com/teerthsharma/NeMo-Relay" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "lambda-topo", url: "https://github.com/teerthsharma/lambda-topo" },
      { name: "topoflow", url: "https://github.com/teerthsharma/topoflow" },
      { name: "topoml", url: "https://github.com/teerthsharma/topoml" },
      { name: "phi-mem", url: "https://github.com/teerthsharma/phi-mem" },
    ]),
  ...
  },
  {
    ...
    // guessed — "Seal OS" and "ISO boot proof" have none.
    repos: Object.freeze([
      { name: "vec-simd", url: "https://github.com/teerthsharma/vec-simd" },
      { name: "pgtable-asm", url: "https://github.com/teerthsharma/pgtable-asm" },
      { name: "topo-asm", url: "https://github.com/teerthsharma/topo-asm" },
    ]),
