...
export const SW_MECHANISM_VISUAL_CONTRACTS = deepFreeze({
  ...
  "topology-archive-wall": {
    ...
    silhouette: "long insulated ice-core cold store on a skid platform — seamed panel walls, an open bay showing four tiers of racked core tubes, and a core-logging rig travelling the rack line",
    material: "desaturated grey-mauve insulated panels with real seams over graphite steel racks, pale ice core tubes, a magenta logger scan line on the rack index labels, warm amber bench worklight and drift snow",
    colorScope: "station-local materials only",
