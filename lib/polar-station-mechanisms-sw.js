...
export const SW_MECHANISM_VISUAL_CONTRACTS = deepFreeze({
  "upstream-radio-mast": {
    ...
    silhouette: "aviation-banded lattice broadcast mast with a face-on coral/mint radar dish on a side pivot, blinking warm tip beacon, antenna farm, and guy-line stays",
    material: "alternating coral and warm-ivory aviation paint bands over graphite base steel, warm white dish hardware, mint waveguide beacons, and descending mint signal packets",
  ...
  "topology-archive-wall": {
    ...
    silhouette: "paired staggered relational canyon of notched graphite strata monoliths — a strata barcode canyon read by a sweeping scan gantry across a navigable central aperture",
    material: "dark graphite strata faces cut by magenta data seams and mauve shelf crowns, with an open gantry scan reader, persistent provenance traces, and ignition light",
    colorScope: "station-local materials only",
  ...
  "assembly-tool-locker": {
    ...
    silhouette: "ski-legged graphite toolkit chamber with a panelled cladding shell, open front gangway, suspended assembly rails and a lit relic bench of merged upstream tools",
    material: "graphite steel chamber frame over desaturated panel cladding, violet accent seams, coral safety trim, amber forge and porthole light, brass and steel relic tooling",
    colorScope: "station-local materials only",
    contact: "two snow skids and four load footings carry the deck and the complete gantry mass",
