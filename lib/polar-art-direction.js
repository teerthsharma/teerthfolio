...
export const POST_PROCESS_BUDGET = Object.freeze({
  ...
  //
  // Ringing, counted as pixels pushed outside their neighbourhood's range in the
  // matched control by more than 8 levels: 0.01-0.03% of edge pixels at medium
  // and 0.16% at low, with no highlight clipping and 0.04% shadow clipping at
  // low. The ring guard holds. This is a small, safe recovery and not a
  // transformation; it is here because it is free, not because it is large.
  //
