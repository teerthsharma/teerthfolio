...
export const POST_PROCESS_BUDGET = Object.freeze({
  ...
  //
  //   medium   +3.6%   delta +0.150 on all four pairs   sd 0.000
  //   low      +4.8%   delta +0.204 on all four pairs   sd 0.001
  //   ringing  0.00% at both, against a null control that is also 0.00%
  //
  // Neither tier clips highlights; low clips 0.020% of shadows. Low takes the
