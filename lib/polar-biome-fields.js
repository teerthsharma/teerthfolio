...
const profiles = {
  "observatory-plaque": {
    ...stationPersonalityBiomeIdentity("observatory-plaque", {
      ...
      weather: { fieldKind: 0, speed: 0.22, angleDegrees: 102, opacity: 0.15 },
    }),
    fieldKind: 0,
    angleDegrees: 12,
    centerXZ: [-15, 7],
  ...
  "s2-kernel-core": {
    ...stationPersonalityBiomeIdentity("s2-kernel-core", {
      ...
      weather: { fieldKind: 1, speed: 0.16, angleDegrees: 38, opacity: 0.13 },
    }),
    fieldKind: 1,
    angleDegrees: 38,
    centerXZ: [-5, 13],
  ...
  "manifold-reactor": {
    ...stationPersonalityBiomeIdentity("manifold-reactor", {
      ...
      weather: { fieldKind: 2, speed: 0.08, angleDegrees: -27, opacity: 0.11 },
    }),
    fieldKind: 2,
    angleDegrees: -27,
    centerXZ: [8, 12],
  ...
  "field-chamber-coils": {
    ...stationPersonalityBiomeIdentity("field-chamber-coils", {
      ...
      weather: { fieldKind: 3, speed: 0.48, angleDegrees: 74, opacity: 0.12 },
    }),
    fieldKind: 3,
    angleDegrees: 74,
    centerXZ: [17, 4],
  ...
  "qpu-ice-bridge": {
    ...stationPersonalityBiomeIdentity("qpu-ice-bridge", {
      ...
      weather: { fieldKind: 4, speed: 0.1, angleDegrees: -48, opacity: 0.12 },
    }),
    fieldKind: 4,
    angleDegrees: -48,
    centerXZ: [15, -8],
  ...
  "upstream-radio-mast": {
    ...stationPersonalityBiomeIdentity("upstream-radio-mast", {
      ...
      weather: { fieldKind: 5, speed: 0.62, angleDegrees: 19, opacity: 0.16 },
    }),
    fieldKind: 5,
    angleDegrees: 19,
    centerXZ: [3, -14],
  ...
  "topology-archive-wall": {
    ...stationPersonalityBiomeIdentity("topology-archive-wall", {
      ...
      weather: { fieldKind: 6, speed: 0.18, angleDegrees: 61, opacity: 0.1 },
    }),
    fieldKind: 6,
    angleDegrees: 61,
    centerXZ: [-11, -11],
  ...
  "assembly-tool-locker": {
    ...stationPersonalityBiomeIdentity("assembly-tool-locker", {
      ...
      weather: { fieldKind: 7, speed: 0.34, angleDegrees: -9, opacity: 0.11 },
    }),
    fieldKind: 7,
    angleDegrees: -9,
    centerXZ: [-18, -2],
...
vec3 polarSkyAnchor(vec3 direction) {
  ...
  vec3 cyanHorizon = vec3(0.72, 0.84, 0.85);
  vec3 ivoryZenith = vec3(0.965, 0.955, 0.91);
  return mix(cyanHorizon, ivoryZenith, altitude);
}
...
vec3 polarSnowAnchor(vec2 worldXZ) {
  ...
  vec3 cyanShadow = vec3(0.76, 0.84, 0.875);
  vec3 lavenderShadow = vec3(0.79, 0.80, 0.875);
  vec3 warmSnow = vec3(0.965, 0.945, 0.895);
...
void main() {
  ...
  color = mix(color, atmosphereTint, weather * (vBiomeRole > 0.5 ? 0.14 : 0.09));
  ...
  if (vBiomeRole < 0.5 || vBiomeRole > 1.5) {
    ...
    vec3 neutralFogColor = vec3(0.76, 0.84, 0.85);
