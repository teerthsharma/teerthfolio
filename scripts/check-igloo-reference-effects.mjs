...
const checks = [
  ...
  ["quality budget preserves authored medium and high geography", biomeFields, /low:[\s\S]*geographyInstances:\s*0[\s\S]*medium:[\s\S]*geographyInstances:\s*24[\s\S]*high:[\s\S]*geographyInstances:\s*32/],
